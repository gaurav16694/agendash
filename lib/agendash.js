...
module.exports = function(agenda, options) {
  ...
  const getOverview = callback => {
    ...
    collection.aggregate([
      ...
      const states = ['total', 'running', 'scheduled', 'queued', 'completed', 'failed', 'repeating','disabled','upcoming'];
